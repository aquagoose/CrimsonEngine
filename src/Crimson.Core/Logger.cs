...
/// <summary>
/// Log useful messages for debugging.
/// </summary>
public static class Logger
{
    ...
    /// <summary>
    /// Enable/disable logging to the console. If compiling with DEBUG, this is enabled by default.
    /// </summary>
    public static bool LogToConsole
    {
        ...
        set
        {
            // ensure we don't subscribe/unsubscribe to the event more than once
            if (field == value)
                return;
    ...
    /// <param name="file">The calling file path.</param>
    ...
    private static void WriteMessageToConsole(string message, Severity severity)
    {
    ...
    /// <summary>
    /// Defines the various severities that a log message can be.
    /// </summary>
    public enum Severity
    {
        /// <summary>
        /// Verbose messages, logging exact codepaths and trace debug info.
        /// </summary>
        Trace,

        /// <summary>
        /// Debug messages that are primarily useful for debugging.
        /// </summary>
        Debug,
