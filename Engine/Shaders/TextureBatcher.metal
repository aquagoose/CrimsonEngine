...
struct Camera_default_0
{
    matrix<float,int(4),int(4)>  Projection_0;
    matrix<float,int(4),int(4)>  View_0;
    float3 Position_0;
    float _padding1_0;
};
...
{
    Camera_default_0 constant* camera_0;
    texture2d<float, access::sample> sprite_texture_0;
    sampler sprite_sampler_0;
};


#line 33 "TextureBatcher.slang"
[[fragment]] pixelOutput_0 PSMain(pixelInput_0 _S1 [[stage_in]], float4 Position_1 [[position]], Camera_default_0 constant* camera_1 [[buffer(0)]], texture2d<float, access::sample> sprite_texture_1 [[texture(0)]], sampler sprite_sampler_1 [[sampler(0)]])
{
...
#line 10
[[vertex]] VSMain_Result_0 VSMain(vertexInput_0 _S3 [[stage_in]], Camera_default_0 constant* camera_2 [[buffer(0)]], texture2d<float, access::sample> sprite_texture_2 [[texture(0)]], sampler sprite_sampler_2 [[sampler(0)]])
{
...
#line 23
    ...
    (&output_1)->Position_4 = ((((((float4(_S3.Position_3, 0.0f, 1.0f)) * (camera_2->View_0)))) * (camera_2->Projection_0)));
...
#line 27
    (&_S4)->Position_2 = output_1.Position_4;
